...
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::ScheduledShutdownValue_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::SessionProperty_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::Inhibitor_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::Seat_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::Session_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::User_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::SessionPath_p)
Q_DECLARE_METATYPE(DLOGIN1_NAMESPACE::UserPath_p)
