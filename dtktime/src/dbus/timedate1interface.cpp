...
QDBusPendingReply<> TimeDate1Interface::setLocalTime(const bool use_NTP, const bool interactive)
{
    QDBusPendingReply<> reply = m_inter->asyncCallWithArgumentList(QLatin1String("SetLocalTime"), {use_NTP, interactive});
    return reply;
};
