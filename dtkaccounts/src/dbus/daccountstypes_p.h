...
Q_DECLARE_METATYPE(DTK_ACCOUNT_NAMESPACE::LoginHistory_p)
Q_DECLARE_METATYPE(DTK_ACCOUNT_NAMESPACE::ReminderInfo_p)
Q_DECLARE_METATYPE(DTK_ACCOUNT_NAMESPACE::ShadowInfo_p)
Q_DECLARE_METATYPE(DTK_ACCOUNT_NAMESPACE::LoginUtmpx_p)
