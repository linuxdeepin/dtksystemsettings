...
public:
    ...
    inline void setBatteryLockDelay(const qint32 value) { m_inter->setProperty("BatteryLockDelay", QVariant::fromValue(value)); }
    ...
    inline void setScreenBlackLock(const bool value) { m_inter->setProperty("ScreenBlackLock", QVariant::fromValue(value)); }
    inline bool sleepLock() const { return qdbus_cast<bool>(m_inter->property("SleepLock")); }
    inline void setSleepLock(const bool value) { m_inter->setProperty("SleepLock", QVariant::fromValue(value)); }
