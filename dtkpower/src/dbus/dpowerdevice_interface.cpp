...
DPowerDevice_interface::getHistory(const QString &type, const quint32 timespan, const quint32 resolution)
{
...
QDBusPendingReply<QList<Statistic_p>> DPowerDevice_interface::getStatistics(const QString &type)
{
