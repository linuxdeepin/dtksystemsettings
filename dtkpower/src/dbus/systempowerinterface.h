...
public:
    ...
    Q_PROPERTY(bool PowerSavingModeEnabled READ powerSavingModeEnabled WRITE setPowerSavingModeEnabled NOTIFY
    ...
    inline bool powerSavingModeEnabled() const { return qdbus_cast<bool>(m_inter->property("PowerSavingModeEnabled")); }
    ...
    inline void setCpuBoost(const bool value) { m_inter->setProperty("CpuBoost", QVariant::fromValue(value)); }
