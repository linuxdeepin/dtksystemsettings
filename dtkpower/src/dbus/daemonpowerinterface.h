...
public:
    ...
    Q_PROPERTY(qint32 BatteryLidClosedAction READ batteryLidClosedAction WRITE setBatteryLidClosedAction NOTIFY BatteryLidClosedActionChanged);
    Q_PROPERTY(qint32 BatteryLockDelay READ batteryLockDelay WRITE setBatteryLockDelay NOTIFY BatteryLockDelayChanged);
    Q_PROPERTY(qint32 BatteryPressPowerBtnAction READ batteryPressPowerBtnAction WRITE setBatteryPressPowerBtnAction NOTIFY BatteryPressPowerBtnActionChanged);
    Q_PROPERTY(qint32 BatteryScreenBlackDelay READ batteryScreenBlackDelay WRITE setBatteryScreenBlackDelay NOTIFY BatteryScreenBlackDelayChanged);
    Q_PROPERTY(qint32 BatteryScreensaverDelay READ batteryScreensaverDelay WRITE setBatteryScreensaverDelay NOTIFY BatteryScreensaverDelayChanged);
    Q_PROPERTY(qint32 BatterySleepDelay READ batterySleepDelay WRITE setBatterySleepDelay NOTIFY BatterySleepDelayChanged);
    Q_PROPERTY(qint32 LinePowerLidClosedAction READ linePowerLidClosedAction WRITE setLinePowerLidClosedAction NOTIFY LinePowerLidClosedActionChanged);
    ...
    Q_PROPERTY(qint32 LinePowerPressPowerBtnAction READ linePowerPressPowerBtnAction WRITE setLinePowerPressPowerBtnAction NOTIFY LinePowerPressPowerBtnActionChanged);
    Q_PROPERTY(qint32 LinePowerScreenBlackDelay READ linePowerScreenBlackDelay WRITE setLinePowerScreenBlackDelay NOTIFY LinePowerScreenBlackDelayChanged);
    Q_PROPERTY(qint32 LinePowerScreensaverDelay READ linePowerScreensaverDelay WRITE setLinePowerScreensaverDelay NOTIFY LinePowerScreensaverDelayChanged);
    Q_PROPERTY(qint32 LinePowerSleepDelay READ linePowerSleepDelay WRITE setLinePowerSleepDelay NOTIFY LinePowerSleepDelayChanged);
    Q_PROPERTY(qint32 LowPowerAutoSleepThreshold READ lowPowerAutoSleepThreshold WRITE setLowPowerAutoSleepThreshold NOTIFY LowPowerAutoSleepThresholdChanged);
    ...
    Q_PROPERTY(qint32 LowPowerNotifyThreshold READ lowPowerNotifyThreshold WRITE setLowPowerNotifyThreshold NOTIFY LowPowerNotifyThresholdChanged);
    ...
    inline qint32 batteryLidClosedAction() const { return qdbus_cast<qint32>(m_inter->property("BatteryLidClosedAction")); }
    ...
    inline qint32 batteryLockDelay() const { return qdbus_cast<qint32>(m_inter->property("BatteryLockDelay")); }
    inline void setBatteryLockDelay(const qint32 value) {
        m_inter->setProperty("BatteryLockDelay", QVariant::fromValue(value));
    }
    inline qint32 batteryPressPowerBtnAction() const { return qdbus_cast<qint32>(m_inter->property("BatteryPressPowerBtnAction")); }
    ...
    inline qint32 batteryScreenBlackDelay() const { return qdbus_cast<qint32>(m_inter->property("BatteryScreenBlackDelay")); }
    ...
    inline qint32 batteryScreensaverDelay() const { return qdbus_cast<qint32>(m_inter->property("BatteryScreensaverDelay")); }
    ...
    inline qint32 batterySleepDelay() const { return qdbus_cast<qint32>(m_inter->property("BatterySleepDelay")); }
    inline void setBatterySleepDelay(const qint32 value) {
        m_inter->setProperty("BatterySleepDelay", QVariant::fromValue(value));
    }
    inline qint32 linePowerLidClosedAction() const { return qdbus_cast<qint32>(m_inter->property("LinePowerLidClosedAction")); }
    ...
    inline qint32 linePowerLockDelay() const { return qdbus_cast<qint32>(m_inter->property("LinePowerLockDelay")); }
    inline void setLinePowerLockDelay(const qint32 value) {
        m_inter->setProperty("LinePowerLockDelay", QVariant::fromValue(value));
    }
    inline qint32 linePowerPressPowerBtnAction() const { return qdbus_cast<qint32>(m_inter->property("LinePowerPressPowerBtnAction")); }
    ...
    inline qint32 linePowerScreenBlackDelay() const { return qdbus_cast<qint32>(m_inter->property("LinePowerScreenBlackDelay")); }
    ...
    inline qint32 linePowerScreensaverDelay() const { return qdbus_cast<qint32>(m_inter->property("LinePowerScreensaverDelay")); }
    ...
    inline qint32 linePowerSleepDelay() const { return qdbus_cast<qint32>(m_inter->property("LinePowerSleepDelay")); }
    inline void setLinePowerSleepDelay(const qint32 value) {
        m_inter->setProperty("LinePowerSleepDelay", QVariant::fromValue(value));
    }
    inline qint32 lowPowerAutoSleepThreshold() const { return qdbus_cast<qint32>(m_inter->property("LowPowerAutoSleepThreshold")); }
    ...
    inline bool lowPowerNotifyEnable() const { return qdbus_cast<bool>(m_inter->property("LowPowerNotifyEnable")); }
    inline void setLowPowerNotifyEnable(const bool value) {
        m_inter->setProperty("LowPowerNotifyEnable", QVariant::fromValue(value));
    }
    inline qint32 lowPowerNotifyThreshold() const { return qdbus_cast<qint32>(m_inter->property("LowPowerNotifyThreshold")); }
    ...
    inline bool screenBlackLock() const { return qdbus_cast<bool>(m_inter->property("ScreenBlackLock")); }
...
public slots:
    QDBusPendingReply<> reset() {
        return m_inter->asyncCall("Reset");
    }
